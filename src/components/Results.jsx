...
// STEP 3.5: Now that these steps are done, the userInput state has been lifted to the App component and the userInput state variable object is being shared between / passed down to both the UserInput and here to the Results component. We can now use this userInput state variable object and the calculateInvestmentResults function, which must be imported, to calculate the results here.
